        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-canter pt-5">
                    <div class="autor-img">
                        <p align="center">
                            <img src="{{ asset($AuthorDetail->image) }}" alt="featured image" class="img-fluid mb-1">
                        </p>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class=" col-md-2 col-12 mb-3">
                        <img src="{{URL::to('storage/app')}}/{{$bok->cover_image}}" alt="featured image"
                            class="w-100 mb-1" height="226px">
                ...
                <div class=" col-md-2 col-12 mb-3">
                    <div class="card8 text-center mt-5">
                        ...
                        <div class="card-body border-0 p-0 text-center">
                            ...
                            <a href="{{URL::to('author-profile')}}/{{$other->userId}}"><span class="">View
                                    Profile</span></a>
                        </div>
                    </div>
                </div>
