                                ...
                                <div class="col">
                                    <div class="logo-box"><a href="#" class="logo-text"><img src="{{URL::to('/public/assests/img/logo.png')}}" width="250px" height="150px" alt=""></a></div>
                                        @if(Session::has("success"))
                                            <div class="alert alert-success">Your registeration has been successfull. Admin will active you</div><br>
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter username" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Username</label>
                                            <input type="text" name="username" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter username" required>
                                        </div>
                                        <div class="form-group">
