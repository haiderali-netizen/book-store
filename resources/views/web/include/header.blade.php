                              ...
                              <div class="input-group ml5" style="padding-left: 68px">
                                 ...
                                 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    @foreach($AllBookCategories as $bookCat)
                                       <a class="dropdown-item show-read-more" href="#" type="category" src="{{$bookCat->id}}">{{$bookCat->name}}</a>
                                    @endforeach
                                    @foreach($AllBookTypes as $bookTyp)
                                       <a class="dropdown-item show-read-more" href="#" type="type" src="{{$bookTyp->id}}">{{$bookTyp->name}}</a>
                                    @endforeach
                                 </div>
                                 </div>
                                 </div>
                                 <div class="width-input">
                                    <input type="search" name="terms" class="form-control form-control-height searchsite" id="searchsite" required autocomplete="off">
                                 </div>
                                 <div>
