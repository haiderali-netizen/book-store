                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{ \App\Models\Stationary::find($data->productId)->value('name') }}
                            @elseif ($data->type == 'book')
                            {{ \App\Models\BookModel::find($data->productId)->value('name') }}
                            @elseiff($data->type == 'gift')
                            {{ \App\Models\Gift::find($data->productId)->value('title') }}
                            @endif
                        </td>
                        <td>{{$data->quantity}}</td>
                    </tr>
