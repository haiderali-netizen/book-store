    ...
    <div class="row p-3" style="background-color:white">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                <h4>All FAQs</h4>
                <p>
                    <a href="{{URL::to('admin/faq/add')}}" class="btn btn-primary btn-sm mr-2">Add New</a>
                </p>
            </div><br>
                <p class="text-right">
                ...
                <tbody>
                    @foreach($totalData as $data)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{URL::to('admin/faq/update')}}/{{$data->id}}" class="btn btn-primary btn-sm">Update</a>
                                <a href="{{URL::to('admin/faq/delete')}}/{{$data->id}}" class="deleteAlert btn btn-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
