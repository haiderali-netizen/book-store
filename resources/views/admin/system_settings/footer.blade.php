                ...
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <div class="accordion faq-area" id="accordionExample">
                            ...
                            <textarea name="description" class="form-control mb-2 descriptionFooter"
                                    ...
                                    <div class="row">
                                        ...
                                        @for ($i = 0; $i < count($sociallink); $i++ ) @if ($i> 0)
                                            <div class="element{{$icount}}">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                                        ...
                                                        <input type="text" name="link[]" value="{{$sociallink[$i]}}"
                                            ...
                                            <div class="buttons text-right mt-2">
                                                <i class="fa fa-minus remove ml-2 text-danger cursorpointer"
                                                    element="element{{$icount}}"></i>
                                            </div><br>
                                            @endif
                                            @php $icount++ @endphp
                                            @endfor
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-12 col-sm-12">
                        <form action="" method="post" enctype="multipart/form-data">
                            <h5>First</h5>
                            <img src="{{URL::to('storage/app')}}/{{$data[6]->icon}}" width="100px" height="100px"
                                alt="">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-12 col-sm-12">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <textarea name="store_location" id="store_location" cols="30" rows="10" class="form-control"
                                placeholder="Enter google map iframe with width 200 and height 200"></textarea>
                            <label for=""> Tilte </label>
                    ...
                    <div class="col-md-6 col-lg-6 col-12 col-sm-12">
                        <form action="" method="post" enctype="multipart/form-data">
                            <label for=""> Icon </label>
                            <input name="icon" type="text" class="form-control mb-2" value="{{$data[9]->icon}}"
                                required>
                            <label for=""> Tilte </label>
                    ...
                    <div class="col-md-6 col-lg-6 col-12 col-sm-12">
                        <form action="" method="post" enctype="multipart/form-data">
                            <label for=""> Icon </label>
                            <input name="icon" type="text" class="form-control mb-2" value="{{$data[10]->icon}}"
                                required>
                            <label for=""> Tilte </label>
                    ...
                    <div class="col-md-6 col-lg-6 col-12 col-sm-12">
                        <form action="" method="post" enctype="multipart/form-data">
                            <label for=""> Icon </label>
                            <input name="icon" type="text" class="form-control mb-2" value="{{$data[11]->icon}}"
                                required>
                            <label for=""> Tilte </label>
