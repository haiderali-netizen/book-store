    ...
    <div class="row p-3" style="background-color:white">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                <h4>All News</h4>
                <a href="{{URL::to('admin/system-settings/testimonial/add')}}" class="btn btn-primary btn-sm">Add
                    New</a>
            </div><br>
            <p class="text-right">
            ...
            <table id="myTable" class="table table-striped table-bordered nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset($data->image) }}" alt="" width="100px" height="100px"></td>
                        <td>
                            <a href="{{URL::to('admin/system-settings/testimonial/update')}}/{{$data->id}}"
                                class="btn btn-primary btn-sm">Update</a>
                            <a href="{{URL::to('admin/system-settings/testimonial/delete')}}/{{$data->id}}"
