    ...
    <div class="row p-3" style="background-color:white">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="{{URL::to('admin/system-settings/main-slider/add')}}" class="btn btn-primary btn-sm">Add New</a>
            </div><br>
                <p class="text-right">
                ...
                <tbody>
                    @foreach($totalSocial as $data)
                        <tr>
                            ...
                            <td><img src="{{URL::to('storage/app')}}/{{$data->image}}" width="100px" height="100px" alt=""></td>
                            <td>{{$data->h1}}</td>
                            <td>{{$data->h2}}</td>
                            <td>
                                <a href="{{URL::to('admin/system-settings/main-slider/update')}}/{{$data->id}}" class="btn btn-primary btn-sm">Update</a>
                                <a href="{{URL::to('admin/system-settings/main-slider/delete')}}/{{$data->id}}" class="btn btn-danger btn-sm deleteAlert">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
