    ...
    <div class="row p-3" style="background-color:white">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                <h4>All Main Mune</h4>
                <a href="{{URL::to('admin/system-settings/main-menu/add')}}" class="btn btn-primary btn-sm">Add New</a>
            </div><br>
                <p class="text-right">
                ...
                <tbody>
                    @foreach($totalSocial as $data)
                        <tr>
                            ...
                            <td>{{$data->name}}</td>
                            <td><a href="{{URL::to('')}}/{{$data->link}}">{{URL::to('')}}/{{$data->link}}</a></td>
                            <td>
                                <a href="{{URL::to('admin/system-settings/main-menu/update')}}/{{$data->id}}" class="btn btn-primary btn-sm">Update</a>
                                <a href="{{URL::to('admin/system-settings/main-menu/delete')}}/{{$data->id}}" class="btn btn-danger btn-sm deleteAlert">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
