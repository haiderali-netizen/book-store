    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <select name="categoryId" class="form-control" required>
                    ...
                    <option value="{{$cat->id}}" {{$cat->id == $data->categoryId ? 'selected' : ''}}>{{$cat->name}}
                    </option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <select name="authorId" class="form-control" required>
                    ...
                    @endphp
                    <option value="{{$userInfo->userId}}" {{$userInfo->userId == $data->authorId ? 'selected' : ''}}>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <input type="checkbox" class="mr-3" name="recommded_all" {{$data->recommded_all == 1 ? 'checked' : ''}}
                    value="1" style="height: 11px;">
                <label for=""> Recommded For You Only</label>
                <input type="checkbox" name="recommded_only" value="1" {{$data->recommded_only == 1 ? 'checked' : ''}}
                    style="height: 11px;">
            </div>
        </div><br />
