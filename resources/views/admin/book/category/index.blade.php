    ...
    <div class="row p-3" style="background-color:white">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                <h4>All Books Category</h4>
                <a href="{{URL::to('admin/book/category/add')}}" class="btn btn-primary btn-sm">Add New</a>
            </div><br>
            <p class="text-right">
                ...
                <tbody>
                    @foreach($totalCategory as $data)
                        <tr>
                            ...
                            <td>{{$data->name}}</td>
                            <td>
                                <a href="{{URL::to('admin/book/category/update')}}/{{$data->id}}" class="btn btn-primary btn-sm">Update</a>
                                <a href="{{URL::to('admin/book/category/delete')}}/{{$data->id}}" class="btn btn-danger btn-sm deleteAlert">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
