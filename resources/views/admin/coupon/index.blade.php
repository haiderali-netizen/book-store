    ...
    <div class="row p-3" style="background-color:white">
        ...
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                <h4>All Coupon</h4>
                <a href="{{URL::to('admin/coupon/add')}}" class="btn btn-primary btn-sm">Add New</a>
            </div><br>
            <p class="text-right">
                ...
                <tbody>
                    @foreach($totalCoupon as $data)
                        <tr>
                            ...
                            <td>{{$data->endDate}}</td>
                            <td>
                                <a href="{{URL::to('admin/coupon/update')}}/{{$data->id}}" class="btn btn-primary btn-sm">Update</a>
                                <a href="{{URL::to('admin/coupon/delete')}}/{{$data->id}}" class="btn btn-danger btn-sm deleteAlert">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
